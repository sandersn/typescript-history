...
export const releases: Releases = [{
    ...
    description: "improved quick info; other improvements in the type system and debugger",
    ...
    description: "Generics, overloading on string literals, export=, enums, namespace merging, re-engineered compiler.",
    ...
    notes: "noImplicitAny is introduced as if it were a secret option that was productised because people started using it."
}, {
    date: "2013/08/21",
    version: "0.9.1.1",
    title: "TypeScript 0.9.1.1 Released",
    description: "bug fixes and backward compatibility flags for `bool` and `import x = module(...)`",
    ...
    notes: "Over 200 .d.ts files in Definitely Typed; VS Code was recently announced. _references.ts was a proto-tsconfig.json"
}, {
    date: "2014/02/25",
    version: "1.0 RC",
    title: "TypeScript 1.0 RC",
    description: "Simplified generic assignability, better overload merging, updated lib.d.ts",
    link: "https://devblogs.microsoft.com/typescript/announcing-typescript-1-0rc/",
    notes: "Simultaneous with VS 2013 Update 2 CTP 2. Also known as 0.9.7. First announcement with long descriptions of features."
}, {
    date: "2014/04/02",
    version: "1.0",
